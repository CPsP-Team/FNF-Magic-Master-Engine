...
class Magic {
    ...
    public static function curtomSliceRect(_x:Float, _y:Float, _width:Int, _height:Int, _image:String):{data:FlxUI9SliceSprite, info:Array<String>} {
        ...
        return {info: slice_info, data: new FlxUI9SliceSprite(_x, _y, _image.getGraphic(true), new Rectangle(0, 0, _width, _height), FlxStringUtil.toIntArray(slice_info[0]), FlxUI9SliceSprite.TILE_BOTH)};
    }
    ...
    public static function getShader(_shader:String):FlxCustomShader {
        ...
        var new_shader:FlxCustomShader = new FlxCustomShader({fragmentsrc: Files.getText(Paths.shader(_shader))});
