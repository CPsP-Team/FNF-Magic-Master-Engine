...
class StrumLine extends FlxTypedGroup<Dynamic> {
    ...
    inline public function get_x():Float{return staticnotes.x;}
    inline public function set_x(x:Float):Float{return staticnotes.x = x;}

    public var y(get, set):Float;
    inline public function get_y():Float{return staticnotes.y;}
    inline public function set_y(y:Float):Float{return staticnotes.y = y;}

    public var alpha(get, set):Float;
    inline public function get_alpha():Float{return staticnotes.alpha;}
    inline public function set_alpha(alpha:Float):Float{return staticnotes.alpha = alpha;}

    public var strum_size(get, never):Int; inline function get_strum_size():Int{return staticnotes.strum_size;}
    public var height(get, never):Int; inline function get_height():Int{return staticnotes.line_height;}
    ...
    public var width(get, never):Int; inline function get_width():Int{return staticnotes.line_width;}
    ...
    public function new(X:Float, Y:Float, ?_keys:Int, ?_size:Int, ?_image:String, ?_style:String, ?_type:String){
        ...
        splashIcon.onSplashed = () -> { splashIcon.kill(); }
        add(splashIcon);
        splashIcon.kill();
    ...
    public function changeKeys(_keys:Int, ?_size:Int){
        staticnotes.changeKeys(_keys, _size);
    ...
    override function update(elapsed:Float){
        ...
        if(controls != null && controls.hasGamepad){
        ...
        notes.forEachAlive(function(daNote:Note){
            ...
            if(!daNote.customInput){
                ...
                if(conductor.position > daNote.strumTime + (350 / getScrollSpeed()) && daNote.noteStatus != "Pressed" && daNote.noteStatus != "Missed"){missNOTE(daNote); return;}
            }
    ...
    public function destroyNote(daNote:Note):Void {
    ...
    public function rankNote(daNote:Note){
        ...
        if(Settings.get("SplashNotes") && splash_notes && isUsing && _score >= 350){splashNote(daNote);}
