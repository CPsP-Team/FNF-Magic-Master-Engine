...
class Action_Plus {
	...
	public function bindButtons(id:Int, buttons:Array<FlxGamepadInputID>){
	...
	public function unbindButtons(id:Int, buttons:Array<FlxGamepadInputID>){
		unbindActionButtons(id, release, buttons);
		unbindActionButtons(id, press, buttons);
		unbindActionButtons(id, hold, buttons);
	}
...
class Controls extends FlxActionSet {
    ...
    public static function init():Void {
		...
		Controls._save.bind('controls', 'Yirius125');

		Controls._key_save = new FlxSave();
		Controls._key_save.bind('key_controls', 'Yirius125');
    ...
    public static function reset():Void {
        ...
        Controls.current.push(new Control_Input("Start", [FlxKey.ENTER, FlxKey.SPACE], [FlxGamepadInputID.START, FlxGamepadInputID.A]));
        Controls.current.push(new Control_Input("Emote", [FlxKey.SPACE], []));
        ...
        Controls.current_key.push(new Control_Input("4", [FlxKey.D, FlxKey.F, FlxKey.J, FlxKey.K], []));
        Controls.current_key.push(new Control_Input("5", [FlxKey.D, FlxKey.F, FlxKey.SPACE, FlxKey.J, FlxKey.K], []));
        Controls.current_key.push(new Control_Input("6", [FlxKey.S, FlxKey.D, FlxKey.F, FlxKey.J, FlxKey.K, FlxKey.L], []));
        Controls.current_key.push(new Control_Input("7", [FlxKey.S, FlxKey.D, FlxKey.F, FlxKey.SPACE, FlxKey.J, FlxKey.K, FlxKey.L], []));
    ...
    public function data_by_key(_keys:Int, _key:FlxKey):Int {
        if(current_key[_keys - 1] == null){return -1;}
        return current_key[_keys - 1].keys.indexOf(_key);
    }
    public function data_by_button(_keys:Int, _button:FlxGamepadInputID):Int {
        if(current_key[_keys - 1] == null){return -1;}
        return current_key[_keys - 1].buttons.indexOf(_button);
    }
}