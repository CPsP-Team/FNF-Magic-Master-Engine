...
import flixel.addons.text.FlxCustomTypeText;
...
class Dialogue extends FlxUIGroup {
	...
	public var dialogue_flixel_text:FlxCustomTypeText;
	...
	public function new(_data:Dynamic, ?options:Dynamic){
		...
		dialogue_flixel_text = new FlxCustomTypeText(dialogue_data.dialogue_position[0], dialogue_data.dialogue_position[1], 0);
